...
def convert_isaaclab_to_lerobot(
    ...
    frame_skip: int = 3,
    root: str = "./datasets/lerobot/omx_data",
):
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Convert IsaacLab dataset to LeRobot format (OMX)")
    parser.add_argument("--task", type=str, required=True, help="Task name (e.g., OMX_PickPlace)")
    parser.add_argument("--robot_type", type=str, default="OMX", help="Robot type (default: OMX)")
    parser.add_argument(
        "--dataset_file",
        type=str,
