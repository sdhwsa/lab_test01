...
def convert_isaaclab_to_lerobot(
    ...
    frame_skip: int = 3,
    root: str = "./datasets/lerobot/so101_data",
):
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Convert IsaacLab dataset to LeRobot format (SO101)")
    parser.add_argument("--task", type=str, required=True, help="Task name (e.g., SO101_PickPlace)")
